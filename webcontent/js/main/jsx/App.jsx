...
class App extends React.Component {
    ...
    addQuestion(e)
	{
		...
		var quiz={question:'New Question',options:['option1','options2']};
	...
	{var me=this;
		...
		return (<DesignQuestion key={i}  id={i} defaultquestionNo={this.state.defaultquestionNo} addOption={this.addOption} deleteOption={this.deleteOption} changeOptions={this.changeOptions} writeQuestion={this.writeQuestion} options={info.options}/>);	
	}
	Questions(data,i)
	{
			const tooltip = (
